...
public class AtlasClientV3 extends AtlasBaseClient {
     ...
     * @param domain
     */
    public AtlasClientV3(String[] baseUrl, String cookieName, String value, String path, String domain) {
    ...
    public AtlasClientV3(Configuration configuration, String[] baseUrl, String[] basicAuthUserNamePassword) {
    ...
    public static class API_V2 extends API {
        ...
        public static final API_V2 UPDATE_BULK_SET_CLASSIFICATIONS = new API_V2(ENTITY_API + AtlasClientV3.BULK_SET_CLASSIFICATIONS, HttpMethod.POST, Response.Status.OK);
