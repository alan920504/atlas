...
public class AtlasClientV3Test {
    @Mock
    ...
    private WebResource.Builder setupBuilder(AtlasClientV3.API_V2 api, WebResource webResource) {
    ...
    public void updateClassificationsShouldNotThrowExceptionIfResponseIs204() {
        ...
        AtlasClientV3 atlasClient = new AtlasClientV3(service, configuration);
        ...
        WebResource.Builder builder = setupBuilder(AtlasClientV3.API_V2.UPDATE_CLASSIFICATIONS, service);
